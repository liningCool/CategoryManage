...
+ (BOOL)isValidPhone:(NSString *)phone
{
    ...
    NSString * mobile19 = @"^19[0-9]\\d{8}$";
    NSString * mobile20 = @"^16[0-9]\\d{8}$";
    ...
    NSPredicate *mobile20Predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", mobile20];
    ...
    if ([mobile13Predicate evaluateWithObject:phone]
        ...
        || [mobile20Predicate evaluateWithObject:phone])
    {
        return YES;
    }
