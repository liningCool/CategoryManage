...
#import "UILabel+ZLAttributeTextTapAction.h"
...
FOUNDATION_EXPORT double CategoryManageVersionNumber;
FOUNDATION_EXPORT const unsigned char CategoryManageVersionString[];
